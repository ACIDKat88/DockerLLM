...
function ChatPage() {
  ...
  async function fetchSources(query, dataset) {
    try {
      const response = await fetch("https://docker-llm-backend--6b5efca2ab.jobs.scottdc.org.apolo.scottdata.ai/api/sources", {
        method: "POST",
        headers: {
  ...
  const fetchChatHistories = async () => {
    try {
      const response = await fetch(
        'https://docker-llm-backend--6b5efca2ab.jobs.scottdc.org.apolo.scottdata.ai/api/chat/histories',
        {
          method: 'GET',
          headers: {
            'Content-Type': 'application/json',
  ...
  const handleSelectModel = (model) => {
    ...
    if (sessionToken) {
      ...
      const endpoint = "https://docker-llm-backend--6b5efca2ab.jobs.scottdc.org.apolo.scottdata.ai/api/user/preferences";
  ...
  useEffect(() => {
    ...
    if (sessionToken) {
      ...
      axios.get("https://docker-llm-backend--6b5efca2ab.jobs.scottdc.org.apolo.scottdata.ai/api/me", { headers })
        .then(response => {
          ...
          if (response.data && response.data.username) {
            ...
            return axios.get("https://docker-llm-backend--6b5efca2ab.jobs.scottdc.org.apolo.scottdata.ai/api/user", { headers });
          }
        })
        .then(response => {
          ...
          if (response.data && response.data.username) {
            ...
            return axios.get("https://docker-llm-backend--6b5efca2ab.jobs.scottdc.org.apolo.scottdata.ai/api/current_user", { headers });
          }
        })
        .then(response => {
          if (!response) return;
  ...
  useEffect(() => {
    ...
    const checkUserStatusInterval = setInterval(() => {
      fetch('https://docker-llm-backend--6b5efca2ab.jobs.scottdc.org.apolo.scottdata.ai/api/user/preferences', {
        method: 'GET',
        headers: {
          'Content-Type': 'application/json',
          'Authorization': sessionToken
      ...
      .then(response => {
        if (!response.ok) {
          ...
          localStorage.removeItem('session_token');
          window.location.href = 'https://docker-llm-backend--6b5efca2ab.jobs.scottdc.org.apolo.scottdata.ai/signin';
        }
        return response.json();
      })
      .catch(error => {
