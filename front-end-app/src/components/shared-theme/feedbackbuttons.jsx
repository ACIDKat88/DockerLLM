...
const postFeedback = async (feedbackType, feedbackData, sessionToken) => {
  ...
  if (feedbackType === "positive") {
    endpoint = "https://j1chatbotbeta.usgovvirginia.cloudapp.usgovcloudapi.net/api/feedback/positive";
  } else if (feedbackType === "neutral") {
    endpoint = "https://j1chatbotbeta.usgovvirginia.cloudapp.usgovcloudapi.net/api/feedback/neutral";
  } else if (feedbackType === "negative") {
    endpoint = "https://j1chatbotbeta.usgovvirginia.cloudapp.usgovcloudapi.net/api/feedback/negative";
  } else {
