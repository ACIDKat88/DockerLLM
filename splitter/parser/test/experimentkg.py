...
results_df.to_csv('/home/cm36/Updated-LLM-Project/csv/results_j1_kg_preprocessed.csv', index=False)
print("Results saved to /home/cm36/Updated-LLM-Project/csv/results_j1_kg_preprocessed.csv")
