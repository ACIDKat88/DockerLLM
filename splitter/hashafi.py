...
PDF_FILE_PATH = '/home/cm36/Updated-LLM-Project/J1_corpus/cleaned/airmen_afi'
JSON_OUTPUT_PATH = '/home/cm36/Updated-LLM-Project/J1_corpus/json/kg'

# (A) Detect chapter lines ("CHAPTER X")
chapter_number_line_regex = re.compile(r"^CHAPTER\s+(\d+)$", re.IGNORECASE)
...
def generate_pdf_hashes(pdf_folder, output_folder):
    ...
    output_file = os.path.join(output_folder, "hashes_airmen.json")
    hash_mapping = {}
